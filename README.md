...
- **macOS** — Gatekeeper blocks it → open **System Settings → Privacy &amp; Security → Open Anyway**, or run `xattr -d com.apple.quarantine /Applications/Prowl.app` in Terminal, then open it. Ensure that you point to the correct folder.
